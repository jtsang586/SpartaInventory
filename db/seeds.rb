...
item = Item.create({description:'Macbook 2010', serial: 'DFRUY3TGV333', academy_id: 'Richmond'})
item1 = Item.create({description:'Macbook 2011', serial: 'LOPUY3TG111', academy_id: 'Richmond'})
item2 = Item.create({description:'Macbook 2012', serial: 'GHTJUY90K000', academy_id: 'Richmond'})
item3 = Item.create({description:'Macbook 2013', serial: 'ASDJUY90K777', academy_id: 'Richmond'})
